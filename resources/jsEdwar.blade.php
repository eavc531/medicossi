    ...
    <div class="col-12 col-lg-4 m-auto col-sm-6 col-md-6 p-1">
      ...
      <div class="my-2">
        <div class="col-12 text-center">
          ...
          <a onclick="return confirm('Acutalmente posee activo el plan: '+{{$plan_actual->name}}+' con fecha de vencimiento: '+{{$plan_actual->name}}+'¿Esta segur@ de querer cambiar el plan?')" class="btn btn-primary btn-block" href="{{route('contract_basic',Auth::user()->medico_id)}}">Contratar</a>
        </div>
      </div>
    </div>
  </div>
