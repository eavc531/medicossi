		...
		<nav class="navbar navbar-expand-md navbar-config d-none d-lg-block">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<span class="font-navbar d-none d-lg-block">¡Siempre encontrarás tu mejor opción!</span>
				</ul>
					...
					<ul class="navbar-nav">
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle textAuth" href="#" id="navbarDropdown" role="button" data-toggle="dropdown">
								...
								<b class="text-azul">Administrador: </b> &nbsp; <span>{{Auth::user()->administrator->name}} {{Auth::user()->administrator->lastName}}
									@elseif (Auth::user()->role == 'Paciente')</span>
