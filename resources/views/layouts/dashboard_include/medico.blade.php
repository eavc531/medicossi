...
<div class="box-dashboard" id="dashboard">
  ...
  <div class="row">
    ...
    <div class="col-12">
      ...
      <div class="col-12">
        <a href="{{route('medico_stipulate_appointment',['medico_id'=>\Hashids::encode($medico->id),'patient_id'=>\Hashids::encode($patient['id'])])}}" class="btn btn-block btn-config-dashboard color-medic"><i class="far fa-calendar-check"></i><span>Agendar Cita</span></a>
      </div>
      @plan_platino
      <div class="col-12">
...
<div class="box-dashboard" id="dashboard">
  ...
  <div class="row">
    ...
    @plan_agenda
    <div class="col-12">
      <a href="#" class="btn btn-block btn-config-dashboard color-medic"><i class="fas fa-mobile-alt"></i><span>Soporte Tecnico</span></a>
    </div>
    @endplan_agenda
  </div>
</div>
