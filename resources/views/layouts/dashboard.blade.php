                ...
                @else
                    ...
                    <div class="box-dashboard" id="dashboard">
                      ...
                      <div class="row py-1">
                        ...
                        <div class="col-12">
                          <a href="{{route('salubridad_reports',\Hashids::encode(Auth::user()->medico_id))}}" class="btn btn-block btn-config-dashboard color-medic"><i class="fas fa-clipboard-list"></i><span>Reportes de Salubridad</span></a>
                        </div>
                        <div class="col-12">
                      ...
                      @plan_profesional
                          <div class="col-12">
                            <a href="{{route('calification_medic',\Hashids::encode(Auth::user()->medico_id))}}" class="btn btn-block btn-config-dashboard color-medic"><i class="far fa-list-alt"></i><span>Calificación</span> @if(Auth::user()->medico->calification_not_see != 0)
                                <span style="font-size:10px;background:rgb(222, 46, 8);border-radius:10px;padding:5px;border-color:white;"><i class="fas fa-bell"></i> ({{Auth::user()->medico->calification_not_see}})</span>
                                @endif
                            </a>
                          </div>
                      @endplan_profesional
