            ...
            <div class="box-dashboard" id="dashboard">
              ...
              <div class="row py-1">
                <div class="col-12">
                    ...
                    <a href="{{route('medico_diary', Auth::user()->medico_id)}}" class="btn btn-block btn-config-dashboard color-medic"><i class="far fa-bell"></i> <span>Citas <span style="font-size:10px;background:rgb(214, 84, 19);border-radius:10px;padding:5px">Nuevas ({{Auth::user()->medico->notification_number}})</span> </span></a>
