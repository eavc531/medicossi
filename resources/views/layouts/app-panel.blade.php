...
<html>
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-config d-none d-lg-block">
...
{{-- 					@if(Auth::check())
					...
					--}}
					<span class="font-navbar">¡Siempre encontrarás tu mejor opción!</span>
				</ul>
						...
						<ul class="navbar-nav">
							<li class="nav-item dropdown">
								...
								<a class="nav-link dropdown-toggle textAuth" href="#" id="navbarDropdown" role="button" data-toggle="dropdown">
									...
									<strong class="text-azul">Administrador:</strong> {{Auth::user()->administrator->name}} {{Auth::user()->administrator->lastName}}
									@elseif (Auth::user()->role == 'Paciente')
									<strong class="text-azul">Paciente:</strong> {{Auth::user()->patient->name}} {{Auth::user()->patient->lastName}}
									@elseif (Auth::user()->role == 'medico')
									<strong class="text-azul">Medico:</strong> {{Auth::user()->medico->name}} {{Auth::user()->medico->lastName}}
									...
									<span class="text-azul"> asistiendo a:</span>
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12 text-center my-2">
									<span class="btn-block btn-lg btn-green d-block d-sm-none" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style="border-radius:0;"><i class="fa fa-plus mb-2 mr-2"></i>Menu</span>
								</div>
					...
					<footer>
						<div class="section-footer sticky-bottom">
							<div class="row align-items-center nomargin p-1">
								<div class="col-12 col-sm-6  text-center nopadding">
