\Hashids::encode($note->id)@extends('layouts.app')
...
<div class="card">
  ...
  <div class="card-body">
    {!!Form::model($note,['route'=>['note_config_store',\Hashids::encode($note->id)],'method'=>'POST'])!!}
      ...
      @if(request()->expedient_id != Null)
        <input type="hidden" name="expedient_id" value="{{request()->expedient_id}}">
          <input type="submit" class="btn btn-success line mx-1" name="boton_submit" value="Guardar Nota">
      @else
