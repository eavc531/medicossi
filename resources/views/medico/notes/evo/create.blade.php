...
<div class="row">
  <div class="col-12 mb-3">
      <h2 class="text-center font-title">Crear Nueva Nota de Evolucion</h2>
  </div>
</div>
{{-- MENU DE PACIENTES --}}
...
<div class="card">
  ...
  <div class="card-body">
    {!!Form::model($note,['route'=>['note_store',\Hashids::encode($note->id)],'method'=>'POST','id'=>'myform'])!!}
      ...
      <div class="form-group">
       ...
       @if($note->Evolucion_y_actualizacion_del_cuadro_clinico_show == 'si')
         ...
         {{Form::textarea('Evolucion_y_actualizacion_del_cuadro_clinico',null,['class'=>'form-control area element',"id"=>"Evolucion_y_actualizacion_del_cuadro_clinico"])}}
       @else

         {{Form::textarea('Evolucion_y_actualizacion_del_cuadro_clinico',null,['class'=>'form-control area element',"id"=>"Evolucion_y_actualizacion_del_cuadro_clinico",'style'=>'display:none'])}}
       @endif
      </div>
  ...
  @include('medico.notes.modal_report_salub')
    ...
    <script type="text/javascript">
        function show_modal_report(){
            ...
            if(text.length == 0){
                $("#text_diagnostic").attr('placeholder','No se agrego diagnostico para esta nota pero puedes editar este campo para tu reporte de salubridad');
            }else{
