...
<div class="col-4">
<a class="mr-1 btn btn-primary btn-sm line" href="{{route('note_egreso_create',['medico_id'=>$medico->id,'patient_id'=>$patient->id,'note_id'=>$note->id])}}"><i class="fas fa-plus"></i></a>
