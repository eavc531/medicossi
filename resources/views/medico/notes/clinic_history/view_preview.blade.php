...
<div class="row">
  <div class="col-12 mb-3">
    <h2 class="text-center font-title">Vista previa Historia Clinica: "{{\Carbon\Carbon::parse($clinic_history->created_at)->format('d-m-Y H:i')}}" </h2>

<p class="text-justify text-secondary">La Historia Clinica muestra todas las notas por fecha para imprimiras en un solo documento, tambien puede eliminar los documentos que no desea mostrar, si desea una mayor personalizacion puede usar los expedientes donde podrar crear y añadir las notas que desee.</p>
<div class="text-right">
  ...
  <a href="{{route('clinic_history_pdf',\Hashids::encode($clinic_history->id))}}" class="btn btn-info ml-auto mr-3">Descargar en pdf</a>
...
<div class="col-12" style="text-align:center;font-size:27px;color:rgb(125, 120, 120);margin-bottom:20px">
  ...
  <div class="" style="text-align:center;font-size:20px;color:rgb(125, 120, 120);margin-bottom:20px">
    {{$medico->state}} - {{$medico->city}} - {{\Carbon\Carbon::now()->format('d/m/Y')}}</p>
  </div>
</div>
...
<div class="card-body">
  <div class="text-center mb-3">
    <div class="text-center font-title" style="">
      <h3 style="text-decoration: underline;">Historia Clinica</h3>
    </div>
  </div>
  ...
  <div class="col-12">   {{-- ///////////Content --}}
    @foreach ($history_note as $expedient_n)
      <div class="text-center" style="margin-bottom:80px;margin-top:80px">
          <a onclick="confirm('¿Esta Segur@ de Eliminar esta Nota de la Historia Clinica?, la nota se mantendra en el panel de notas y podra crear luego otra historia clinica.')" href="{{route('history_note_delete',\Hashids::encode($expedient_n->id))}}" class="float-right text-danger"><i class="fas fa-times"></i></a>
