...
<div class="row">
  <div class="col-12 mb-3">
    <h4 class="text-center font-title">Campos Pruebas de laboratorio predefinidos</h4>
...
<div class="card mb-3" style="max-width:400px">
    <div class="card-header bg-success text-white">
        Agregar Campo Pruebas de laboratorio
    </div>
    <div class="card-body">
        {{Form::open(['route'=>'medico_test_labs_store','method'=>'post'])}}
...
<div class="mb-5">
  <div class="text-center">
    <h4 class="font-title-blue">Pruebas de laboratorio</h4>
  </div>
</div>
...
<div class="row">
        @foreach ($test_labs as $vital)
            <div class="col-4">
            <div class="card mt-2">
                <div class="card-body">
                        {{Form::open(['route'=>'test_lab_delete','method'=>'POST'])}}
                    {{$vital->name_question}}
