    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="text-center">
              ...
              <a href="{{route('medico_vital_signs',['medico_id'=>\Hashids::encode($medico->id),'patient_id'=>\Hashids::encode($patient->id),'note_id'=>\Hashids::encode($note->id),'back'=>Route::currentRouteName(),'expedient_id'=>request()->expedient_id])}}" class="btn btn-success">Aceptar y Continuar</a>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
          </div>
