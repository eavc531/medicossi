    ...
    <div class="col-12 mb-1">
      ...
      @if($type == 'sin confirmar')
        ...
        {{-- @if ($medico->plan == 'plan_profesional' or $medico->plan == 'plan_platino') --}}
          ...
          <a href="{{route('appointments',request()->id)}}" class="btn btn-warning disabled mt-2" disabled> Nuevas / sin confirmar</a>
          <a href="{{route('appointments_confirmed',request()->id)}}" class="btn btn-primary mt-2"> Citas confirmadas o Creadas por médico</a>
        {{-- @endif --}}
        <a href="{{route('appointments_paid_and_pending',request()->id)}}" class="btn btn-info mt-2"> Pagadas y Pendientes</a>
        <a href="{{route('appointments_past_collect',request()->id)}}" class="btn text-white mt-2" style="background:rgb(119, 38, 88)">Pasadas y por cobrar</a>
        <a href="{{route('appointments_completed',request()->id)}}" class="btn btn-secondary mt-2"> Completadas</a>
      ...
      @elseif($type == 'confirmadas')
        ...
        {{-- @if ($medico->plan == 'plan_profesional' or $medico->plan == 'plan_platino') --}}
          ...
          <a href="{{route('appointments_confirmed',request()->id)}}" class="btn btn-primary disabled mt-2" disabled> Citas confirmadas o Creadas por médico</a>
        {{-- @endif --}}
        <a href="{{route('appointments_paid_and_pending',request()->id)}}" class="btn btn-info mt-2"> Pagadas y Pendientes</a>
        <a href="{{route('appointments_past_collect',request()->id)}}" class="btn text-white mt-2" style="background:rgb(119, 38, 88)">Pasadas y por cobrar</a>
        <a href="{{route('appointments_completed',request()->id)}}" class="btn btn-secondary mt-2"> Completadas</a>
      ...
      @elseif($type == 'Pagadas y Pendientes')
        ...
        {{-- @if ($medico->plan == 'plan_profesional' or $medico->plan == 'plan_platino') --}}
          ...
          <a href="{{route('appointments_confirmed',request()->id)}}" class="btn btn-primary mt-2"> Citas confirmadas o Creadas por médico</a>
        {{-- @endif --}}
        <a href="{{route('appointments_paid_and_pending',request()->id)}}" class="btn btn-info disabled mt-2"> Pagadas y Pendientes</a>
        <a href="{{route('appointments_past_collect',request()->id)}}" class="btn text-white mt-2" style="background:rgb(119, 38, 88)">Pasadas y por cobrar</a>
        <a href="{{route('appointments_completed',request()->id)}}" class="btn btn-secondary mt-2"> Completadas</a>
      ...
      @elseif($type == 'Pagadas y Completadas')
        ...
        <a href="{{route('appointments_paid_and_pending',request()->id)}}" class="btn btn-info mt-2"> Pagadas y Pendientes</a>
        <a href="{{route('appointments_past_collect',request()->id)}}" class="btn text-white mt-2" style="background:rgb(119, 38, 88)">Pasadas y por cobrar</a>
        <a href="{{route('appointments_completed',request()->id)}}" class="btn btn-secondary disabled mt-2 text-black" style="color:black"> Completadas</a>
        <a href="{{route('appointments_canceled',request()->id)}}" class="btn btn-danger mt-2"> Canceladas</a>
      @elseif($type == 'todas')
      ...
      @elseif($type == 'Pasada y por Cobrar')
        ...
        {{-- @endif --}}
        <a href="{{route('appointments_paid_and_pending',request()->id)}}" class="btn btn-info mt-2"> Pagadas y Pendientes</a>
        <a href="{{route('appointments_past_collect',request()->id)}}" class="btn text-white disabled mt-2" style="background:rgb(119, 38, 88)">Pasadas y por cobrar</a>
        <a href="{{route('appointments_completed',request()->id)}}" class="btn btn-secondary text-black mt-2" style="color:black"> Completadas</a>
        <a href="{{route('appointments_canceled',request()->id)}}" class="btn btn-danger mt-2"> Canceladas</a>
      @else
        <a href="{{route('appointments_all',request()->id)}}" class="btn btn-success mt-2">Todas</a>
        ...
        <a href="{{route('appointments_past_collect',request()->id)}}" class="btn text-white mt-2" style="background:rgb(119, 38, 88)">Pasadas y por cobrar</a>
        <a href="{{route('appointments_completed',request()->id)}}" class="btn btn-secondary mt-2"> Completadas</a>
        <a href="{{route('appointments_canceled',request()->id)}}" class="btn btn-danger disabled mt-2" disabled> Canceladas</a>
      @endif
