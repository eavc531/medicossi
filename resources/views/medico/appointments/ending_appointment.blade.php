  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-9 col-12">
          <div class="row">
            <div class="col-12">
               <h3 class="text-center font-title">Finalizar Consulta: {{$event_edit->title}} {{\Carbon\Carbon::parse($event_edit->start)->format('d-m-Y')}}, Paciente: {{ $event_edit->namePatient}}</h3>
            </div>
          </div>
          <div class="row">
