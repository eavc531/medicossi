...
@else
    <button onclick="reminder_delete()" type="button" name="button" class="btn btn-danger btn-block" id="rechazar" disabled>Eliminar</button>
    @endreminder_delete
  </div>
  <div class="col-4">
...
@else
    <div class="row">
      <div class="col-lg-4 col-12">
        <div class="form-group">
          <label for="" class="font-title">Titulo</label>
          {!!Form::text('title',null,['class'=>'form-control','id'=>'title9','disabled'])!!}
      ...
      <div class="col-8">
        <div class="form-group">
          <label for="" class="font-title">Descripción (Opcional)</label>
          {!!Form::textarea('description',null,['class'=>'form-control','id'=>'description9','style'=>'height:80px','disabled'])!!}
    ...
    <div class="row">
      ...
      <div class="col-3">
        <label for="Estado" class="font-title">Estado:</label>
        {{Form::text('state',null,['class'=>'form-control','id'=>'state9','readonly','disabled'])}}
      </div>

      <div class="col-lg-3 col-12">
        <div class="form-group">
          <label for="" class="font-title">Fecha de inicio</label>
          {!!Form::date('date_start',null,['class'=>'form-control','id'=>'dateStart9','disabled'])!!}
      ...
      <div class="col-3">
        <div class="form-group">
          ...
          <div class="row">
            <div class="col">{!!Form::select('hourStart',['00'=>'00','01'=>'01','02'=>'02','03'=>'03','04'=>'04','05'=>'05','06'=>'06','07'=>'07','08'=>'08','09'=>'09','10'=>'10','11'=>'11','12'=>'12','13'=>'13','14'=>'14','15'=>'15','16'=>'16','17'=>'17','18'=>'18','19'=>'19','20'=>'20','21'=>'21','22'=>'22','23'=>'23'],null,['class'=>'form-control','id'=>'hourStart9','disabled'])!!}</div>
            <div class="col">
              {!!Form::select('minsStart',['00'=>'00','15'=>'15','30'=>'30','45'=>'45'],null,['class'=>'form-control','id'=>'minsStart9','disabled'])!!}
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-3">
        <div class="form-group text-center">
          <label for="" class="font-title" class="mx-3">Hora de Culminación</label>
          <div class="row">
            <div class="col-lg-6 my-1">{!!Form::select('hourEnd',['00'=>'00','01'=>'01','02'=>'02','03'=>'03','04'=>'04','05'=>'05','06'=>'06','07'=>'07','08'=>'08','09'=>'09','10'=>'10','11'=>'11','12'=>'12','13'=>'13','14'=>'14','15'=>'15','16'=>'16','17'=>'17','18'=>'18','19'=>'19','20'=>'20','21'=>'21','22'=>'22','23'=>'23'],null,['class'=>'form-control','id'=>'hourEnd9','disabled'])!!}</div>
            <div class="col-lg-6 my-1"> {!!Form::select('minsEnd',['00'=>'00','15'=>'15','30'=>'30','45'=>'45'],null,['class'=>'form-control','id'=>'minsEnd9','disabled'])!!}</div>
          </div>
        </div>
      </div>
    </div>
    ...
    @else
      ...
      <div class="col-4">
        ...
        <input disabled name="mysubmit" type="submit" value="Guardar Cambios" class="btn btn-success btn-block" id="but_save"/>
