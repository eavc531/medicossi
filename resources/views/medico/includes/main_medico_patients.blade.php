  ...
  <div class="col-lg-6 m-auto text-center">
    <div class="row">
      <div class="col-lg col-12 d-flex justify-content-center">
        ...
        <a href="{{route('notes_patient',['m_id'=>$medico->id,'p_id'=>$patient->id])}}" class="btn btn-lg btn-menu-medico btn-menu-medico-verde" data-toggle="tooltip" data-placement="top" title="Notas de Paceinte"><i class="fas fa-notes-medical"></i><span style="font-size:11"></span> </a>
        @endif
        <a href="{{route('medico_stipulate_appointment',['m_id'=>$medico->id,'p_id'=>$patient])}}" class="btn btn-lg btn-menu-medico btn-menu-medico-morado" data-toggle="tooltip" data-placement="top" title="Agendar cita"><i class="far fa-calendar-check"></i><span style="font-size:11"></span></a>
