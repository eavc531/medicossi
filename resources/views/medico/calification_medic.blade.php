  ...
  <div class="row">
    ...
    <div class="col-4">
      <div class="form-inline">
        ...
        {{-- @if ($medico->show_comentary == 'Si') --}}
          <a href="{{route('show_all_comentary',$medico->id)}}" class="btn btn-primary">Si</a>
          <a href="{{route('hide_all_comentary',$medico->id)}}" class="btn btn-warning ml-1">No</a>
        {{-- @else
          <a href="{{route('show_all_comentary',$medico->id)}}" class="btn btn-primary">Si</a>
          <a href="{{route('hide_all_comentary',$medico->id)}}" class="btn btn-warning ml-1 disabled" style="border:solid 3px black">No</a>
        @endif --}}
      </div>
    </div>
  </div>
...
@if($type == 'no_vistas')
  @if($rate_medic2->first())
      ...
      <div class="col-4">
        <a href="{{route('mark_all_see',$medico->id)}}" class="btn btn-primary"><i class="fas fa-check"></i></a>
      </div>
    </div>
  @endif
@endif
  ...
  @if($rate_medic2->first())
    <div class="row mt-4">
      ...
      <div class="col-4">
        ...
        <a href="{{route('show_all_comentary_new',$medico->id)}}" class="btn btn-success"><i class="fas fa-eye"></i>  <i class="fas fa-check"></i>
        </a>
        {{-- <a href="{{route('hide_all_comentary_new',$medico->id)}}" class="btn btn-danger"><i class="fas fa-eye-slash"></i>
        </a> --}}
      </div>
    </div>
  @endif
