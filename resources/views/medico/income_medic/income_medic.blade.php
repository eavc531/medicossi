...
<section class="box-register">
	...
	<div class="container">
      ...
      <h3>Ingresos</h3>
        ...
        <a href="{{route('income_medic',\Hashids::encode(request()->id))}}" class="btn btn-primary disabled space-btw-w-color">Citas Cobradas</a>
        <a href="{{route('income_medic_without_pay',\Hashids::encode(request()->id))}}" class="btn btn-warning space-btw-w-color">Citas por Cobrar</a>
