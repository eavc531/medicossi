...
<section class="container">
  ...
  <div class="row">
    ...
    <div class="col-6 text-right">
      <a href="{{route('medicalCenter.edit',)}}" class="btn btn-secondary">Atras</a>
    </div>
  </div>
  <div class="row mt-3">
    ...
    <div class="col-12 col-lg-6 mt-2">
      <div class="row">
        <div class="col-6 m-auto">
         {!!Form::open(['route'=>['medicalCenter_store_insurrances',\Hashids::encode(request()->id)],'method'=>'POST'])!!}
 ...
 <div class="col-12 col-sm-10 m-sm-auto col-lg-10 m-lg-auto">
  {!!Form::open(['route'=>['medico_store_insurrances',\Hashids::encode(request()->id)],'method'=>'POST'])!!}
        ...
        @foreach ($insurances as $i)
          <div class="col-6">
            <li class="list-group-item d-flex justify-content-between align-items-center">
              {{$i->name}}
              <a href="{{route('delete_insurance',\Hashids::encode($i->id))}}" class="btn badge badge-danger"><i class="fas fa-ban fa-2x"></i></a>
            </li>
          </div>
        @endforeach
      </div>
