      ...
      <div class="row p-0 m-0">
        ...
        <div class="col-12 col-sm-8">
          <div class="input-group">
            {{Form::text('search',null,['class'=>'form-control sizeSearch','placeholder'=>'Ingresar término de búsqueda','id'=>'search'])}}
            <input type="hidden" name="lat" value="" id="lat">
            <input type="hidden" name="lng" value="" id="lng">
            {{-- {{Form::hidden('city',null,['id'=>'city'])}}
            {{Form::hidden('state',null,['id'=>'state'])}} --}}
            <button type="submit" class="ml-2 white order-1"><span id="filter"><i class="fas fa-search fa-2x"></i></span></button>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-12 col-sm-3">
            <div class="col-12 mt-3">
              <div class="form-group">
                <label class="">Ordenar por puntaje </label>
                <div class="d-flex justify-content-center">
                  {{Form::select('filter_ranking',['no'=>'no','si'=>'si'],null,['class'=>'form-control noBorderFocus','id'=>'filter_ranking','style'=>'width:100px'])}}
                </div>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-9">
            <div class="col-12 mt-3">
              ...
              <p class="d-block d-sm-none">Filtrar por: </p>
              <div class="form-row">
                <div class="col-2 d-none d-sm-block">
                  <p class="">Filtrar por: </p>
                </div>
                <div class="col-10 d-none d-sm-block text-left">
                  <button type="button" name="button" onclick="ubicacion()"  class="btn btn-primary btn-ubicacion btn-sm" disabled>Ubicación</button>
                  <button type="button" name="button" onclick="distancia()" class="btn btn-light btn-didstancia btn-sm">Distancia</button>
                </div>
                <div class="col-6 d-block d-sm-none">
                  <button type="button" name="button" onclick="ubicacion()"  class="btn btn-primary btn-ubicacion mr-2 btn-sm" disabled>Ubicación</button>
                </div>
                <div class="col-6 d-block d-sm-none">
                  <button type="button" name="button" onclick="distancia()" class="btn btn-light btn-didstancia btn-sm">Distancia</button>
                </div>
                ...
                <div class="" id="div_ubicacion">
                  <div class="row">
                    <div class="form-group col-6">
                      {!!Form::select('state',$states,request()->state,['class'=>'form-control noBorderFocus','id'=>'stateMedic','placeholder'=>'Estado'])!!}
                    </div>
                    <div class="form-group col-6">
                      {!!Form::select('city',$cities,request()->city,['class'=>'form-control noBorderFocus','id'=>'cityMedic','placeholder'=>'Ciudad'])!!}
                    </div>
                  </div>
                </div>
              ...
              <div class="form-inline">
                ...
                <button type="button" name="button" onclick="ubicacion()"  class="btn btn-primary btn-ubicacion">Ubicación</button>
                <button type="button" name="button" onclick="distancia()" class="btn btn-light btn-distancia" disabled style="color:black">Distancia</button>
              </div>
    ...
    <div class="text-justify mt-3">
      ...
      <div class="card mb-4 shadow">
        <div class="card-header bg-azul text-center">
          Especialidades de la Categoría: {{$category}}
          <a href="{{route('home')}}" class="close text-white"><span aria-hidden="true">&times;</span></a>
        </div>
        <div class="card-body">
          ...
          <div class="d-inline-flex p-2">
            ...
            <button onclick="geolocation2()" type="submit" class="btn btn-outline-azul">
              {{$specialty->name}}
            </button>
      ...
      <div class="row">
        <div class="col-6 col-lg">
          <div class="imgPanelMenu">
            {{Form::open(['route'=>'tolist2','method'=>'get'])}}
            {{Form::hidden('typeSearch','Centro Médico')}}
        ...
        <div class="col-6 col-lg">
          <div class="imgPanelMenu">
            ...
            {{Form::hidden('typeSearch','Médicos y Especialistas')}}
