        ...
        <div class="container">
            ...
            <div class="row mt-1">
                ...
                <div class="col-4 mt-4">
                    <div class="card" style="min-height:100px">
                        <div class="card-body">
                            <h5>Ganancias Generadas: {{$Ganancias_recibidas}} MXN</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4 mt-4">
                    <div class="card" style="min-height:100px">
                        <div class="card-body">
                            <h5>Ganancias Generadas menos Comisiones: {{$Ganancias_recibidas_menos_comisiones}} MXN</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4 mt-4">
                    <div class="card" style="min-height:100px">
                        <div class="card-body">
                            <h5>Comisiones Generadas: {{$comisions_total_mes}} MXN</h5>
                        </div>
                    </div>
                </div>
                <div class="col-4 mt-4">
                    <div class="card" style="min-height:100px">
                        <div class="card-body">
                            <h5>Comisiones Pagadas: {{$comisions_recibidas}} MXN</h5>
                        </div>
                    </div>
                </div>
                <div class="col-4 mt-4">
                    <div class="card" style="min-height:100px">
                        <div class="card-body">
                            <h5>Comisiones por Pagar: {{$comisions_pendientes}} MXN</h5>
                        </div>
                    </div>
                </div>
                {{-- <div class="col-4 mt-4">
...
<div class="row mt-1">
    <div class="col-4 mt-4">
        <div class="card" style="min-height:100px">
            <div class="card-body">
                <h5>Ganancias Totales: {{$Ganancias_totales}} MXN</h5>
            </div>
        </div>
    </div>
    <div class="col-4 mt-4">
        <div class="card" style="min-height:100px">
            <div class="card-body">
                <h5>Ganancias Totales menos Comisiones: {{$Ganancias_totales_menos_comisiones}} MXN</h5>
            </div>
        </div>
    </div>
    <div class="col-4 mt-4">
    ...
    <div class="col-4 mt-4">
        <div class="card" style="min-height:100px">
            <div class="card-body">
                <h5>Comisiones Pagadas: {{$comisions_totales_recibidas}} MXN</h5>
            </div>
        </div>
    </div>
    <div class="col-4 mt-4">
        <div class="card" style="min-height:100px">
            <div class="card-body">
                <h5>Comisiones por Pagar: {{$comisions_totales_pendientes}} MXN</h5>
            </div>
        </div>
    </div>
    {{-- <div class="col-4 mt-4">
...
@section('scriptJS')
    ...
    $(document).ready(function(){
        ...
        comision_mes_1 = $('#comision_mes_t_1').val();
        name_mes_2 = $('#name_mes_2').val();
        comision_mes_2 = $('#comision_mes_t_2').val();
        name_mes_3 = $('#name_mes_3').val();
        comision_mes_3 = $('#comision_mes_t_3').val();
        name_mes_4 = $('#name_mes_4').val();
        comision_mes_4 = $('#comision_mes_t_4').val();
        name_mes_5 = $('#name_mes_5').val();
        comision_mes_5 = $('#comision_mes_t_5').val();
        name_mes_6 = $('#name_mes_6').val();
        comision_mes_6 = $('#comision_mes_t_6').val();
